  ...
  return (
    ...
    <div className="services bg-white mt-[90px]">
        ...
        <div className="container bg-white">
            <h1 className='text-4xl font-bold'>Commercial Cleaning </h1>
            <hr className='h-2 my-6'/>
                <div className="row justify-center items-center ">
                    {
                    Commercial.map((service , index) => (
                        
                        <div key={index} className="col-12 col-md-6 col-lg-4 reletive mt-50 serv flex justify-center" onClick={()=>{handelselect()}}>
                            <Link to='/connect' >
