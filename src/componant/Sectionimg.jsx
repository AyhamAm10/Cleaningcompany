...
const Sectionimg = () => {
  return (
    <div >
        <div style={{"margin":"50px 20px"}} className="tape flex  ">
 ...
 className="container mt-50">
        ...
        <div className="md:flex  ">
            <Cardslider img={comp} header={"Geschäftliche Kunden"} title="lösungen für Firmen" link="/servicesp" titlelink="visit Commercial services"/>
            <Cardslider img={priv}  header={"private Kunde"} title="lösungen für Einzelpersonen" link="/servicesc" titlelink="visit Privat services"/>
        </div>
    </div>
  )
}
